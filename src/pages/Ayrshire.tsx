...
const Ayrshire = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Landscaping Ayrshire | Garden Services Ayr, Kilmarnock, Irvine | Dirtworks</title>
        ...
        {/* OpenGraph */}
        <meta property="og:title" content="Landscaping Ayrshire | Garden Services Ayr, Kilmarnock, Irvine | Dirtworks" />
        ...
        {/* Twitter */}
        <meta name="twitter:title" content="Landscaping Ayrshire | Garden Services Ayr, Kilmarnock, Irvine | Dirtworks" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Dirtworks Landscaping Ltd - Ayrshire Services",
